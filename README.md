[![React App CI](https://github.com/archana2011/ci-cd-with-actions/actions/workflows/ci.yml/badge.svg)](https://github.com/archana2011/ci-cd-with-actions/actions/workflows/ci.yml)
